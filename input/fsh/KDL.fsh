...
* ^property[=].extension[=].valueCanonical = "http://www.dvmd.de/kdlOntology/ValueSet/Zweck"
...
* ^property[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/codesystem-property-valueset"
* ^property[=].extension[=].valueCanonical = "http://www.dvmd.de/kdlOntology/ValueSet/Sector"
...
* ^property[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/codesystem-property-valueset"
* ^property[=].extension[=].valueCanonical = "http://www.dvmd.de/kdlOntology/ValueSet/Component"
...
* ^property[+].code = #patientenbezogen
* ^property[=].uri = "http://www.dvmd.de/kdlOntology/CodeSystem/Property#patientenbezogen"
* ^property[=].description = "besteht ein Patientenbezug"
* ^property[=].type = #boolean
...
* ^property[+].code = #bezugZuDiagnose
* ^property[=].uri = "http://www.dvmd.de/kdlOntology/CodeSystem/Property#bezugZuDiagnose"
* ^property[=].description = "besteht eine Relevanz zu einer bestimmten Diagnose, wen ja, zu welcher"
...
// define dummy codes for filtering properties
// must be fixed later
// (filtering by foreign codes does not work)
* #ambulant "ambulant"
  * ^property[+].code = #abstract
...
* #AU "Aufnahme"
  ...
  * #AU1901 "Rettungsstelle"
    * #AU190101 "Einsatzprotokoll" "Die Dokumentation beinhaltet Angaben über den notarztspezifischen Einsatz. Inkl. Rettungsstellenprotokoll, Nothilfeprotokoll"
      * ^property[+].code = #zweck
      * ^property[=].valueCode = #durchfuehrung
      * ^property[+].code = #sectorQuelle
      * ^property[=].valueCode = #ambulant
      * ^property[+].code = #sectorZiel
      * ^property[=].valueCode = #stationaer
...
Inkl.: Palliativmedizinisches Basisassessment Exkl.: Teambesprechungsprotokoll"
  ...
  * #SD1601 "Dokumente Psychiatrie - Psychotherapie"
    ...
    * #SD160111 "Dokumentation Depression" "Die Dokumentation beinhaltet die diagnostischen Fragenstellungen, die Einschätzung des Schweregrades im Rahmen psychiatrisch-psychotherapeutischer Behandlung. Inkl.: BDI, Goldberg, Früherkennung, Exkl.: Dem Tect, Geriatrische Depressionsskala"
      ...
      * ^property[=].valueBoolean = true
      * ^property[+].code = #bezugZuDiagnose
      * ^property[=].valueString = "Depression"
